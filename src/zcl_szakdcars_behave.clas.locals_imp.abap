CLASS lsc_zkp_i_cars DEFINITION INHERITING FROM cl_abap_behavior_saver.
  ...
  PROTECTED SECTION.
*Egyenlőre a mentésre küldünk csak emailt számlával:
...
*Egyenlőre a mentésre küldünk csak emailt számlával. Késöbb az updatenál lesz sztorno számla plusz új számla egy emailben.
    DATA: cars TYPE STANDARD TABLE OF zszakd_cars.
    DATA: bookings TYPE STANDARD TABLE OF zszakdcarbokings.
