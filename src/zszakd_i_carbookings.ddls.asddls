...
define view entity Zszakd_I_CARBOOKINGS
  as select from zszakdcarbokings
  association        to parent Zszakd_I_CARS     as _Car           on $projection.CarUUID = _Car.CarUUID
  ...
  association [0..*] to ZSZAKD_VH_BOOKING_STATUS as _BookingStatus on $projection.BookingStatus = _BookingStatus.BookingStatus
